...
<div class="col-md-12">
<?php echo do_shortcode('[contact-form-7 id="1269" title="Kryptek - DropBox URL - Updated on June 26, 2021"]'); ?>
</div>
</div>
</div>
</section>
...
<script>
    ...
    function showDropdownContent(){
      ...
      if( this.value == "" ){
        middleSectionImg.src="https://insideoutcreative.io/wp-content/uploads/2021/06/Dynamic-Middle-Section.jpg";
      ...
      if( this.value == "GIF" ){
        middleSectionImg.src="https://insideoutcreative.io/wp-content/uploads/2021/06/Dynamic-Middle-Section-GIF.jpg";
...
<h3 class="section-title position-relative">Unique Offering</h3>
...
<div class="col-md-3">
<img src="https://insideoutcreative.io/wp-content/uploads/2020/08/Kryptek-Email-01-Unique-Offering.jpg" alt="" width="100%">
</div>
...
[select section-type include_blank "GIF" "Video" "Bullet Points" "Paragraph"]
<hr>
</div>
...
<div id="gif" class="d-none complex-section-option">
    ...
    <label>GIF Image Shopw Now Link</label>
...
<div id="bulletPoints" class="d-none complex-section-option">
    ...
    <label>Bullet Points Header</label>
...
<div class="col-md-4">
    <img src="https://insideoutcreative.io/wp-content/uploads/2021/06/Dynamic-Middle-Section.jpg" alt="" width="100%" id="middleSectionImg">
</div>
...
<div class="col-md-9 col-fields">
<h3 class="section-title position-relative">Product Promotion #4</h3>
...
<div class="col-md-9 col-fields">
<h3 class="section-title position-relative">Product Promotion #5</h3>
...
<div class="col-md-4">
<img src="https://insideoutcreative.io/wp-content/uploads/2020/08/Kryptek-Email-02-Product-Promotion.jpg" alt="" width="100%">
</div>
...
<div class="col-md-9 col-fields">
<h3 class="section-title position-relative">Exclusive Offer</h3>
<div class="pl-5">
<label class="field-label position-relative">Add DropBox URL:</label>
[url eo-image-1]
</div> 
...
<!-- start of inner section -->
<div class="row">
<!-- <div class="col-md-3 col-number"></div> -->
<div class="col-md-12 col-fields">
<h3 class="section-title position-relative">Exclusive Offer #2</h3>
<div class="pl-5">
<label class="field-label position-relative">Add DropBox URL:</label>
[url eo-image-2]
</div> 
...
<div class="col-md-4">
<img src="https://insideoutcreative.io/wp-content/uploads/2020/08/Kryptek-Email-03-Exclusive-Offer.png" alt="" width="100%">
</div>
...
<div class="col-md-9 col-fields">
<h3 class="section-title position-relative">Final Teaser</h3>
<div class="pl-5">
<label class="field-label position-relative">Add DropBox URL:</label>
[url ft-image-1]
</div> 
...
<!-- <div class="col-md-3 col-number"></div> -->
<div class="col-md-12 col-fields">
<h3 class="section-title position-relative">Final Teaser #2</h3>
<div class="pl-5">
<label class="field-label position-relative">Add DropBox URL:</label>
[url ft-image-2]
</div> 
...
<div class="col-md-4">
<img src="https://insideoutcreative.io/wp-content/uploads/2020/08/Kryptek-Email-04-Final-Teaser.png" alt="" width="100%">
</div>
    ...
    <tbody>
        <tr>
            <td style="text-align:center;">
                <a href="https://insideoutcreative.io/kryptek/">
        ...
        <tr>
            <td style="text-align:center;">
                <h1>KRYPTEK GRAPHIC DESIGN REQUIRED EMAILER FORM SUBMISSION</h1>
            </td>
        </tr>
        <tr>
            <td style="text-align:center;"><p>You can view the page it was submitted from <a href="https://insideoutcreative.io/kryptek/">here.</a></p></td>
        </tr>
    </tbody>
</table>
<table style="background-color:white;width:100%;max-width:600px;margin:auto;border-left:15px solid #f7f7f7;border-right:15px solid #f7f7f7;">
    ...
    <tr><td style="padding:0 20px;"><p><strong>File Link: </strong><br>[uo-image-1]</p></td></tr>
